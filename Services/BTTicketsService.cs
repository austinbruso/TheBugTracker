...
{
    public class BTTicketsService : IBTTicketService
    {
        ...
        public BTTicketsService(ApplicationDbContext context, IBTRolesService rolesService, IBTProjectService projectService)
        {
            _context = context;
